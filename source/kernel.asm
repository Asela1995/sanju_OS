;sanju --- The sanju Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE sanjuos_VER '1.0.0'	 ;OS version number
	%DEFINE sanjuos_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as sanjuos and its programs
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to SANJU_OS ****************************', 0
	os_version_msg		db 'Version ', sanjuos_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', sanjuos_VER, 0

	dialog_string_1		db 'Welcome to sanju Operating System', 0
